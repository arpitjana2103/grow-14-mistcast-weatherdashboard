...
export default function LocationsPopover({
    ...
    return (
        <div
            className={cn(
                "absolute top-12 w-[20rem] transition-all duration-300 shadow-ring-foreground border-background bg-background border-3 rounded-md z-1000",
                isOpen
...
function FindLocationOnMapItem({
    ...
    return (
        <li
            className={cn(
                "flex cursor-pointer items-center gap-3 border border-primary bg-primary px-2.5 py-2 hover:bg-primary/85 transition-colors z-1000 rounded-sm",
                haveLocations && "mb-1",
            )}
        >
            <NavLink
